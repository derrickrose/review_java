...
public class WordSearchTest {
    ...
    private static final String DIRECTORY = "adevinta_dir";
    private static final String INDEX = "index";
    private static final String FILE_NAME = "adevinta_dir/my_fic" + INDEX + ".txt";
    ...
    public void wordSearchIntegration_Test() {
        ...
        wordSearch.getResultList().forEach((result) -> System.out.println(result.getFileName() + " : " + result.getScore() + "%"));
